# Margi — Final Implementation Plan (RoadSoS Hackathon 2026)
...
**Margi** is a calm, native mobile co-pilot for road emergencies. When signal fails on Indian highways, victims and bystanders still get:
...
roadsafetyhackathon/
├── docs/
│   ├── MARGI_FINAL_IMPLEMENTATION_PLAN.md   ← THIS FILE
│   ├── MARGI_V2_IMPLEMENTATION_PLAN.md      ← archive / appendix
│   └── MARGI_MASTER_BRIEF.md                ← product context
...
2. **Solution:** Margi — journey companion + START + GHP + QR relay  
...
*Margi — IIT Madras Road Safety Hackathon 2026 · RoadSoS*
