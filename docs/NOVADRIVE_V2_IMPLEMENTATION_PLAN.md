# NovaDrive V2 — RoadSoS Hackathon Implementation Plan
...
**NovaDrive V2** is a **native-first** road safety companion (Expo React Native → Android + iOS) with a **calm, large-touch UI**. It combines:
...
| Judge criterion | NovaDrive V2 feature | Proof in demo |
|-----------------|------------------------|---------------|
...
```
roadsafetyhackathon/
├── docs/NOVADRIVE_V2_IMPLEMENTATION_PLAN.md   ← this file
...
*NovaDrive V2 — built for RoadSoS. Calm UI, real logic, honest about platform limits.*
