...
const SEED: Omit<Facility, 'distanceKm' | 'etaMinutes' | 'recommended'>[] = [
  ...
  { id: '313027868', name: 'Sri Ramachandra Medical Centre and Hospital', type: 'hospital', traumaTier: 1, phone: '044-40012345', verified: true },
  { id: '310909754', name: 'Vellore CMC Casualty (NH referral)', type: 'trauma', traumaTier: 1, phone: '0416-2282010', verified: true },
  { id: '1127285905', name: 'Aakash Fertility Centre & Hospital', type: 'hospital', traumaTier: 2, phone: '044-24816676', verified: true },
  { id: '1472969165', name: 'Amma Hospital', type: 'hospital', traumaTier: 2, phone: '044-24840441', verified: true },
  { id: '258978416', name: 'Amrit Hospital', type: 'hospital', traumaTier: 2, phone: '044-26427711', verified: true },
  { id: '289486820', name: 'Apollo Hospitals, Tondiarpet', type: 'hospital', traumaTier: 2, phone: '044-25913333', verified: true },
  { id: '941471945', name: 'Appasamy Hospital', type: 'hospital', traumaTier: 2, phone: '044-30595959', verified: true },
  { id: '941611681', name: 'Appasamy Hospital', type: 'hospital', traumaTier: 2, phone: '044-30595959', verified: true },
  { id: '941621037', name: 'Appolo Clinic', type: 'hospital', traumaTier: 2, phone: '', verified: false },
  { id: '1621246558', name: 'Ashwini Eye Care', type: 'hospital', traumaTier: 2, phone: '044-26573635', verified: true },
  { id: '1185699253', name: 'Avadi Hospital', type: 'hospital', traumaTier: 2, phone: '044-26557989', verified: true },
  { id: '540658116', name: 'B.M.Orthopaedic Hospital', type: 'hospital', traumaTier: 2, phone: '044-26570707', verified: true },
  { id: '310910945', name: 'BM Hospital', type: 'hospital', traumaTier: 2, phone: '044-22670277', verified: true },
  { id: '1446415367', name: 'Bhadra Homeo', type: 'hospital', traumaTier: 2, phone: '044-42428877', verified: true },
  { id: '312000326', name: 'Cancer Institute', type: 'hospital', traumaTier: 2, phone: '044-22209150', verified: true },
  { id: '262452334', name: 'City Tower Hospitals', type: 'hospital', traumaTier: 2, phone: '044-26192626', verified: true },
  { id: '303590777', name: 'Corporation Hospital', type: 'hospital', traumaTier: 2, phone: '044-25958144', verified: true },
  ...
  { id: '310504820', name: 'Goverment dental hospital & collage', type: 'hospital', traumaTier: 2, phone: '044-25340681', verified: true },
  { id: '320275820', name: 'Govt Maternity Hospital', type: 'hospital', traumaTier: 2, phone: '044-28191483', verified: true },
  { id: '308811614', name: 'Hindu Mission Health Services, Kanchipuram', type: 'hospital', traumaTier: 2, phone: '044-22243026', verified: true },
  { id: '320275824', name: 'Institute of Child Health', type: 'hospital', traumaTier: 2, phone: '044-28191135', verified: true },
  { id: '320275839', name: 'Institute of Obstetrics and Gynaecology dd', type: 'hospital', traumaTier: 2, phone: '044-28191483', verified: true },
  { id: '597590621', name: 'JJ Hospital', type: 'hospital', traumaTier: 2, phone: '044-24790462', verified: true },
  { id: '311429396', name: 'K.F. Hospital', type: 'hospital', traumaTier: 2, phone: '044-22245020', verified: true },
  { id: '295544111', name: 'K.H.M.Hospital', type: 'hospital', traumaTier: 2, phone: '044-26423288', verified: true },
  ...
  { id: '310732936', name: 'Kilpauk Medical College', type: 'hospital', traumaTier: 2, phone: '044-28364951', verified: true },
  { id: '310015097', name: 'Military Hospital', type: 'hospital', traumaTier: 2, phone: '044-22342632', verified: true },
  ...
  { id: '1474055555', name: 'Right Hospitals', type: 'hospital', traumaTier: 2, phone: '9500037647', verified: true },
  { id: '983957837', name: 'Sankara Eye Hospital, Kanchipuram', type: 'hospital', traumaTier: 2, phone: '044-27264074', verified: true },
  { id: '442508332', name: 'Sarswathi Hospital', type: 'hospital', traumaTier: 2, phone: '', verified: false },
  { id: '295552092', name: 'Sri Devi Speciality Hospial', type: 'hospital', traumaTier: 2, phone: '044-24792401', verified: true },
  { id: '1015571498', name: 'Srm Speciality Hospital', type: 'hospital', traumaTier: 2, phone: '044-45928692', verified: true },
  { id: '367795605', name: 'St. Thomas Hospital', type: 'hospital', traumaTier: 2, phone: '044-61739393', verified: true },
  { id: '295552091', name: 'Sundaram Medical Foundation', type: 'hospital', traumaTier: 2, phone: '044-26144240', verified: true },
  { id: '1560720462', name: 'Vasan Eye Care Hospital', type: 'hospital', traumaTier: 2, phone: '1800-571-2222', verified: true },
  { id: '595706154', name: 'Vasan Eye Care Hospital, Vadapalani', type: 'hospital', traumaTier: 2, phone: '044-23652100', verified: true },
  { id: '459648701', name: 'Vijaya Heart Centre', type: 'hospital', traumaTier: 2, phone: '044-66646664', verified: true },
